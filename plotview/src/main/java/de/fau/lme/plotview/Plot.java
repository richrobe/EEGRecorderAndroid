...
public abstract class Plot {
    ...
    public static class PlotMarkerDefault extends PlotMarker {
         ...
         *
         * @param mark
         *            One of the DefaultMarks to use as marker.
         * @param paint
         *            can be null
         * @param param
    ...
    public static class PlotChangedListener {
        ...
        /**
         * @param v
         *            the PlotView this Plot & Listener is attached to. If not
     ...
     *
     * @param width
     *            Width of the strokes (default: 1f)
     * @param a
     *            Alpha value
     * @param r
     *            Red
     ...
     *
     * @param surface
     *            Structure has to be filled with missing values.
     */
     ...
     *
     * @param axis
     *            The PlotAxis for which the text is requested.
     * @param pt
     *            The point (pixel) on the screen in axis-direction where the
     *            pin will be located.
